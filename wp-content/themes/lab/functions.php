...
function lab_scripts() {
	wp_enqueue_style( 'lab-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'lab-style', 'rtl', 'replace' );

	wp_enqueue_script( 'lab-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
function dimox_breadcrumbs() {
	...
	$wrap_before    = '<div class="about__way" itemscope itemtype="http://schema.org/BreadcrumbList">'; // открывающий тег обертки
	...
	$link          .= '<a class="about__link" href="%1$s" itemprop="item"><span itemprop="name">%2$s</span></a>';
...
//     wp_enqueue_script( 'main', get_template_directory_uri() . 'js/main.js', array( 'jquery', 'slick.min' ) );
